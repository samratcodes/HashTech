...
const Navbar = () => {
  ...
  return (
    <>
      <nav className={`fixed top-0 w-full rounded-b-full z-50 transition-all duration-300 h-14 ${mounted && scrolled ? 'bg-white shadow-lg backdrop-blur-md' : 'bg-transparent'}`}>
